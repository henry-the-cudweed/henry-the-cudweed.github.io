...
var sliderFunction = function (beforeImage, afterImage, text) {
   // creating Student object
   var sliderVar = {};
   // parameters as keys to this object
   sliderVar.beforeImage = beforeImage;
   sliderVar.afterImage = afterImage;
   sliderVar.text = text;
   // function to greet
   sliderVar.sliderFile = function () {
      return (
"<!DOCTYPE html>
<html>
<title>Cape Ivy</title>
<style>
...
figure { 
position: absolute;
background-image: url(sliderVar." + afterImage + ");
...
#divisor { 
background-image: url(sliderVar." + beforeImage + ");
background-size: cover;
position: absolute;
width: 50%; 
...
var slider1 = sliderFunction(CI-mg108283-after.jpg, CI-mg108283-before.jpg, " text text text");
console.log(slider1.sliderfile());
